...
\include{chapters/00-intro/intro}%                                                      Вступ
\include{chapters/01-problem-overview/problem-overview}%                                Розділ 1
\include{chapters/02-the-core/the-core}%                                                Розділ 2
\include{chapters/03-software-and-experiments/software-and-experiments}%                Розділ 3
\include{chapters/04-conclusion/conclusion}%                                            Висновки
\include{chapters/05-bibliography/bibliography}%                                        Список використаних джерел (+список публікацій автора)
